...
Ans:getElementById: Using this, we can select a specific HTML element by its ID. This works faster than other methods.
...
Ans:By following three steps we can create a new element into the dom
